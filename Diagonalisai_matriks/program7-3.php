...
function diagonalizeMatrix($matrix)
{
    ...
    // Menghitung matriks kovariansi dari data sinyal
...
// Matriks data sinyal sebagai contoh
$matrixSinyal = array(
    array(1, 2, 3),
    array(4, 5, 6),
    array(7, 8, 9),
);
echo "Matriks Data Sinyal:<br>";
foreach ($matrixSinyal as $row) {
    echo implode("\t", $row) . PHP_EOL;
}
// Lakukan diagonalisasi matriks kovariansi untuk mereduksi dimensi data sinyal
$result = diagonalizeMatrix($matrixSinyal);
